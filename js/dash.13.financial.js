...
function fnRenderTagger(){
  ...
  let html = '<div style="font-size:12.5px;font-weight:800;color:#1f2b52;margin-bottom:3px">'
    ...
    + '<details style="margin-bottom:10px;border:1px solid #e6ecf5;border-radius:9px;'
    +   'background:#fbfcfe;padding:8px 11px">'
    + '<summary style="font-size:11px;font-weight:700;color:#1f2b52;cursor:pointer">'
    ...
    +   'Money out. <i>Check it is not also entered in the daily/admin expense book, or it '
    +   'counts twice.</i><br>'
